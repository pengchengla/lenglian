...
public abstract class YinLianPayActivity extends Activity implements Callback, Runnable {
    ...
    /*发起银联支付*/
    private void goYinLianPay(){
        mLoadingDialog = ProgressDialog.show(mContext, // context
                "", // title
                "正在努力的获取tn中,请稍候...", // message
                true); // 进度是否是不确定的，这只和创建进度条有关
        //            需要注意的，在用银联demo给的tn和测试账号的时候，用01测试环境，在真正和后台交互的时候要换成00开发环境，不然报错。
        /*************************************************
    ...
    public boolean handleMessage(Message msg) {
        ...
        if (msg.obj == null || ((String) msg.obj).length() == 0) {
             ...
             * 步骤2：通过银联工具类启动支付插件
             ************************************************/
//            方法（上下文，tn值，开发环境）。tn值就是上面第三后台给的tn，mMode看第一步骤，自己改一下就行了，00开发环境，01测试环境。
